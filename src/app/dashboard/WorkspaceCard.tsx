  ...
  return (
    <div className="flex items-center gap-3">
      <div
        ...
        aria-valuemin={0}
        aria-valuemax={100}
        className="relative h-2.5 flex-1 overflow-hidden rounded-full bg-white/5 ring-1 ring-inset ring-white/5"
      >
        <div
...
function EmptyState({ destroyed }: { destroyed: boolean }) {
  ...
  return (
    <div className="mt-5 overflow-hidden rounded-xl border border-white/[0.06] bg-gradient-to-br from-white/[0.02] to-transparent p-5">
      <div className="flex items-start gap-4">
        <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-brand-500/20 to-purple-500/10 ring-1 ring-brand-500/20">
          <svg
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
...
function StepChip({
  ...
  const TONE_MAP = {
    blue: {
      ...
      num: "bg-blue-500/20 text-blue-200",
    },
    amber: {
      border: "border-amber-500/15",
      bg: "bg-amber-500/[0.04]",
      iconWrap: "bg-amber-500/10 text-amber-300 ring-amber-500/20",
      num: "bg-amber-500/20 text-amber-200",
    },
    rose: {
      border: "border-rose-500/15",
      bg: "bg-rose-500/[0.04]",
      iconWrap: "bg-rose-500/10 text-rose-300 ring-rose-500/20",
      num: "bg-rose-500/20 text-rose-200",
    },
  } as const;
  ...
  return (
    ...
    >
      <div
        ...
        aria-hidden
      />
      <div className="relative w-full max-w-md rounded-2xl border border-white/10 bg-ink-800 p-6 shadow-2xl shadow-rose-950/30 animate-modal-in">
        <div className="flex items-start gap-4">
          <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-rose-500/15 ring-1 ring-rose-500/30">
        ...
        <ul className="mt-5 space-y-2 rounded-lg border border-rose-500/15 bg-rose-500/[0.05] p-4 text-sm text-slate-300">
          {[
...
function ReadyBanner() {
  return (
    <div className="flex items-center gap-3 rounded-xl border border-emerald-500/20 bg-emerald-500/[0.06] p-3 animate-fade-up">
      <SuccessCheck />
...
function SuccessCheck() {
  return (
    <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-emerald-500/10 animate-pop-in">
      <svg
        viewBox="0 0 52 52"
...
const TONES = {
  blue: {
    card: "border-blue-500/20 bg-blue-500/[0.04] hover:border-blue-500/40 hover:bg-blue-500/[0.08]",
    label: "text-blue-300",
    dot: "bg-blue-400 shadow-[0_0_8px_rgba(96,165,250,0.6)]",
    btn: "hover:bg-blue-500/10 hover:text-blue-200 focus:ring-blue-500/50",
    link: "text-blue-300 hover:text-blue-200",
  },
  purple: {
    card: "border-purple-500/20 bg-purple-500/[0.04] hover:border-purple-500/40 hover:bg-purple-500/[0.08]",
    label: "text-purple-300",
    dot: "bg-purple-400 shadow-[0_0_8px_rgba(192,132,252,0.6)]",
    btn: "hover:bg-purple-500/10 hover:text-purple-200 focus:ring-purple-500/50",
    link: "text-purple-300 hover:text-purple-200",
  },
  cyan: {
    card: "border-cyan-500/20 bg-cyan-500/[0.04] hover:border-cyan-500/40 hover:bg-cyan-500/[0.08]",
    label: "text-cyan-300",
    dot: "bg-cyan-400 shadow-[0_0_8px_rgba(34,211,238,0.6)]",
    btn: "hover:bg-cyan-500/10 hover:text-cyan-200 focus:ring-cyan-500/50",
    link: "text-cyan-300 hover:text-cyan-200",
  },
  amber: {
    card: "border-amber-500/20 bg-amber-500/[0.04] hover:border-amber-500/40 hover:bg-amber-500/[0.08]",
    label: "text-amber-300",
    dot: "bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)]",
    btn: "hover:bg-amber-500/10 hover:text-amber-200 focus:ring-amber-500/50",
    link: "text-amber-300 hover:text-amber-200",
  },
  rose: {
    card: "border-rose-500/20 bg-rose-500/[0.04] hover:border-rose-500/40 hover:bg-rose-500/[0.08]",
    label: "text-rose-300",
    dot: "bg-rose-400 shadow-[0_0_8px_rgba(251,113,133,0.6)]",
    btn: "hover:bg-rose-500/10 hover:text-rose-200 focus:ring-rose-500/50",
    link: "text-rose-300 hover:text-rose-200",
  },
  emerald: {
    card: "border-emerald-500/20 bg-emerald-500/[0.04] hover:border-emerald-500/40 hover:bg-emerald-500/[0.08]",
    label: "text-emerald-300",
    dot: "bg-emerald-400 shadow-[0_0_8px_rgba(52,211,153,0.6)]",
    btn: "hover:bg-emerald-500/10 hover:text-emerald-200 focus:ring-emerald-500/50",
      ...
      <div className="mt-1.5 flex items-center gap-2">
        ...
        {copyable && (
          <button
            ...
            className={`flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-md text-slate-500 opacity-0 transition focus:opacity-100 focus:outline-none focus:ring-1 group-hover:opacity-100 ${t.btn}`}
          >
            {copied ? (
