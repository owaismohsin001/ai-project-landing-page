    ...
    <section id="features" className="mx-auto max-w-6xl scroll-mt-16 px-6 py-24">
      ...
      <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {FEATURES.map((f) => (
          <div
            key={f.title}
            className="rounded-2xl border border-white/5 bg-ink-800 p-6 transition hover:border-brand-500/40"
          >
            <div className="grid h-11 w-11 place-items-center rounded-xl bg-brand-600/15">
